...
function App() {
  ...
  const add = ()=>{
    ...
    Axios.post("https://backend-app-gopy.onrender.com/create",{
  ...
  const update = ()=>{
    ...
    Axios.put("https://backend-app-gopy.onrender.com/update",{
  ...
  const deleteCliente = (val)=>{
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Axios.delete(`https://backend-app-gopy.onrender.com/delete/${val.idClientes}`).then((res)=>{
          getClientes(); // Actualiza la lista de clientes
          limpiarCampos(); // Limpia los campos de entrada 
          Swal.fire({
            icon: 'success',
  ...
  const getClientes = ()=>{
    ...
    Axios.get("https://backend-app-gopy.onrender.com/clientes").then((response)=>{
